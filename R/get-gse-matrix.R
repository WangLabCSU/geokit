get_gse_matrix <- function(ids, odir = getwd(), pdata_from_soft = TRUE, add_gpl = NULL, ftp_over_https = FALSE, handle_opts = list()) {
...
download_and_parse_annotation <- function(annotation, assay, odir, ftp_over_https, handle_opts) {
