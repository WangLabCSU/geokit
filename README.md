...
#> ■■■■■■■■■                        500/1765 [411/s] | ETA:  3s
#> ■■■■■■■■■■■■■■■■■■■■■■■■■■       1500/1765 [338/s] | ETA:  1s
#> → Parsing GEO records
#> ■■■■■■■■■■■■■■■■■■■■■■■■■■       1500/1765 [338/s] | ETA:  1sGet records from NCBI for 1765 queries in 6.1s
...
You can also use `geo_meta()` to dynamically create a
self-knowledge-concerned database in real-time.
...
#>  [4] rlang_1.1.6         xfun_0.52           stringi_1.8.4      
#>  [7] generics_0.1.3      textshaping_0.4.0   data.table_1.16.99 
#> [10] glue_1.8.0          htmltools_0.5.8.1   ragg_1.5.0         
#> [13] Biobase_2.64.0      fansi_1.0.6         rmarkdown_2.29     
#> [16] evaluate_1.0.3      tibble_3.2.1        fastmap_1.2.0      
#> [19] yaml_2.3.10         lifecycle_1.0.4     stringr_1.5.1      
#> [22] compiler_4.4.2      dplyr_1.1.4         pkgconfig_2.0.3    
#> [25] systemfonts_1.1.0   digest_0.6.37       R6_2.6.1           
#> [28] tidyselect_1.2.1    utf8_1.2.5          pillar_1.9.0       
#> [31] magrittr_2.0.3      withr_3.0.2         tools_4.4.2        
